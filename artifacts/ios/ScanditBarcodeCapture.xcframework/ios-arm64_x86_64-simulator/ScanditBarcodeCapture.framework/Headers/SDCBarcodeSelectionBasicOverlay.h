 ...
 * Added in version 6.6.0
 *
 * The brush applied to recognized tracked barcodes, by default the value is set to defaultTrackedBrushForStyle:.
 ...
 *
 * By default the value is set to defaultAimedBrushForStyle:.
 */
 ...
 *
 * By default the value is set to defaultSelectingBrushForStyle:.
 */
@property (nonatomic, strong, nonnull) SDCBrush *selectingBrush;
/**
 * Added in version 6.6.0
 *
 * The brush applied to selected barcodes, by default the value is set to defaultSelectedBrushForStyle:.
