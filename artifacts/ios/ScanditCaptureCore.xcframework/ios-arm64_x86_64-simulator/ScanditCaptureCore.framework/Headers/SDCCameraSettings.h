 ...
 *
 * For best performance use the camera settings returned by the capture mode you are using, e.g. SDCBarcodeCapture.recommendedCameraSettings, or SDCBarcodeBatch.recommendedCameraSettings etc.
 *
